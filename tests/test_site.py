...
class SiteTests(unittest.TestCase):
    ...
    def test_question_bank_has_keyword_filter(self):
        page = (SITE / "question-bank/index.html").read_text(encoding="utf-8")
        script = (SITE / "assets/js/app.js").read_text(encoding="utf-8")
        self.assertIn('id="keyword-filter"', page)
        self.assertIn('selectedValue("keyword-filter")', script)
